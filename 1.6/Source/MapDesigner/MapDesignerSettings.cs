...
namespace MapDesigner
{
    ...
    public class MapDesignerSettings : ModSettings
    {
        ...
        public void ParseConfigString(string configString)
        {
            ...
            var fields = typeof(MapDesignerSettings).GetFields();
            List<string> defunct = new List<string>
            {
                "vpe_HelixienVents",        // these settings are defunt and no longer supported, but may appear in older configs
	            "vpe_ChemfuelPonds"
            };
            ...
            foreach (var setting in settingValues)
            {
                ...
                if (!settingName.NullOrEmpty() && !defunct.Contains(settingName))
                {
                    ...
                    {
                        Log.Message("parsing a string, float dictionary");
                    ...
                    {
                        Log.Message("parsing a string, bool dictionary");
